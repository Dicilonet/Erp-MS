...
export default function CustomersPage() {
    ...
    if (isLoading) {
       return (
         <>
            <div className="flex items-center justify-between mt-4 sm:mt-0 mb-6">
            ...
            <Card>
                ...
                <CardContent>
                    {/* Skeletons para la tabla de escritorio */}
                    <div className="hidden md:block border rounded-lg">
                     ...
                     {/* Skeletons para la lista de tarjetas móvil */}
        ...
        <>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-4 sm:mt-0 mb-6">
                <div className='flex-1'>
                    ...
                    <p className="text-muted-foreground">Sincroniza y gestiona los clientes del ERP.</p>
                </div>
