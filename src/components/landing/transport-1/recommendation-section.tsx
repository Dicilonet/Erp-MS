      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <Card className="shadow-2xl">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold">Recomienda a un Socio</CardTitle>
            <CardDescription className="text-lg text-muted-foreground">
              Si estás satisfecho con nuestro servicio, recomiéndanos a un socio comercial. Si se convierte en cliente, ambos recibiréis un descuento en vuestro próximo envío.
            </CardDescription>
          </CardHeader>
          <CardContent>
