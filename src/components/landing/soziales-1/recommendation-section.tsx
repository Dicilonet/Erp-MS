      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <Card className="shadow-2xl">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold">Ayúdanos a Crecer</CardTitle>
            <CardDescription className="text-lg">
              La mejor forma de ayudarnos es corriendo la voz. Si crees en nuestra causa, compártela con tus amigos y contactos.
            </CardDescription>
          </CardHeader>
          <CardContent>
