  ...
  return (
    <section id="contact" className="py-16 lg:py-24">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl font-bold tracking-tight text-green-700 dark:text-green-400">Contáctanos</h2>
        <p className="mt-2 text-lg text-slate-600 dark:text-slate-400">
          ¿Dudas, propuestas de colaboración o prensa? Estamos aquí para escucharte.
        </p>
